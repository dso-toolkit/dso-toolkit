...
yarn tsx ./scripts/list-versions-azure-blob-storage.ts --azure-storage-host "$DT_AZURE_STORAGE_HOST" --azure-storage-container "$DT_AZURE_STORAGE_CONTAINER" --azure-sas-token "$SAS_TOKEN" --github-token "$GH_TOKEN"
