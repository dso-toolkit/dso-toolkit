...
export const ZoekenInLijstCards: StoryObj = {
  name: "Zoeken in lijst cards",
  render: () => {
    return html`
      <div class="container">
        ${headerPartial({
        ...
        <main>
          <div>
            ...
            <p>
              Gebruik deze pagina om te zoeken naar specifieke wetteksten, beleidsinformatie, of andersoortige
              regelgeving die van invloed is op uw leefomgeving.
              ${footnoteTemplate({
                number: 14,
                label:
