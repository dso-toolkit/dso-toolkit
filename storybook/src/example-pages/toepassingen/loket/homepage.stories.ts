                      ...
                      <div class="col-md-5 col-md-push-7">
                        ${richContentTemplate({
                          children: html`
                            ...
                            <p>
                              Doe hier de vergunningcheck om te kijken of u een vergunning nodig heeft of een melding
                              moet doen.
                            </p>
              ...
              ${highlightBoxTemplate({
                ...
                content: richContentTemplate({
                  children: html`
                    ...
                    <p>
                      Weet u al voor welke activiteiten u een vergunning moet aanvragen of een melding moet doen? Dan
                      kan u een aanvraag of melding starten.
                    </p>
