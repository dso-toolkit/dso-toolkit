...
export function cardContainer(): CardContainer {
  return {
    mode: "list",
    cards: [
      {
      ...
      },
      {
        ...
        content: html`De Binckhorst was een groot industrieterrein met 3 binnenhavens langs het water van de Trekvliet.
        De gemeente Den Haag zet zich vanaf 2009 in om een deel van de bedrijven te vervangen door enkele duizenden
        woningen.`,
        interactions: [
          {
            variant: "tertiary",
