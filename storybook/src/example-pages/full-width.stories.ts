            ...
            <div class="col-md-6">
              ${richContentTemplate({
                children: html`
                  ...
                  <p>
                    This paragraph is simply dummy text of the printing and typesetting industry. This paragraph has
                    been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley
                    of type and scrambled it to make a type specimen book. It has survived not only five centuries, but
                    also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in
                    the 1960s with the release of Letraset sheets containing this paragraph passages, and more recently
                    with desktop publishing software like Aldus PageMaker including versions of this paragraph.
                  </p>
                `,
              })}
            </div>
          ...
          ${richContentTemplate({
            children: html`
              ...
              <p>
                ...
                King of the Romans, decided to extend the residence to a palace, which would later be called the
                Binnenhof (Inner Court). He died in 1256 before this palace was completed but parts of it were finished
                by his son Floris V, of which the Ridderzaal (Knights' Hall), still intact, is the most prominent.
              </p>
              <h4>Trivia (h4)</h4>
              ${listTemplate({
                items: [
              ...
              <p>
                ...
                'https://en.wikipedia.org/wiki/Kingdom_of_Holland', modifier: 'extern') %} was a puppet state of the
                First French Empire, was the settlement granted city rights by Louis Bonaparte. After the Napoleonic
                Wars, modern-day Belgium and the Netherlands were combined in the United Kingdom of the Netherlands to
                form a buffer against France. As a compromise, Brussels and Amsterdam alternated as capital every two
                years, with the government remaining in The Hague. After the separation of Belgium in 1830, Amsterdam
                remained the capital of the Netherlands, while the government was situated in The Hague. When the
                government started to play a more prominent role in Dutch society after 1850, The Hague quickly
                expanded. Many streets were specifically built for the large number of civil servants employed in the
                country's government and for the Dutchmen who were retiring from the administration of the Netherlands
                East Indies.
              </p>
              <h4>World War II (h4)</h4>
              <p>
                The city sustained heavy damage during World War II. Additionally, the Atlantic Wall was built through
                the city, causing a large quarter to be torn down by the Nazi occupants. On 3 March 1945, the Royal Air
                Force mistakenly bombed the Bezuidenhout quarter. The target was an installation of V-2 rockets in the
                nearby Haagse Bos park, but because of navigational errors, the bombs fell on a heavily populated and
                historic part of the city. The bombardment wreaked widespread destruction in the area and caused 511
                fatalities.
              </p>
              <h5>More information (h5)</h5>
              <p>
