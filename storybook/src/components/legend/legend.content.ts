      ...
      ${legendItemTemplate({
        ...
        options: html`<fieldset class="form-group dso-radios" aria-errormessage="mijn-id-error-text">
          ...
          <div class="dso-field-container">
            <dso-selectable type="radio" checked identifier="1" value="kleur">Kleur</dso-selectable>
            <dso-selectable type="radio" identifier="2" value="grijstinten">Grijstinten</dso-selectable>
            <dso-selectable type="radio" identifier="3" value="opties-3">Pastel</dso-selectable>
          </div>
        </fieldset>`,
      })}
      ${legendItemTemplate({
