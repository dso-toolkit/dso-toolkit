...
function persoonlijkeGegevensFormGroups(): FormGroup[] {
  return [
    {
      group: "input",
      id: "mijn-voornaam",
...
function overigeVragenFormGroups(): FormGroup[] {
  return [
    {
      group: "files",
      id: "mijn-files",
...
export function formGroupContent(): FormGroup[] {
  return [...persoonlijkeGegevensFormGroups(), ...overigeVragenFormGroups()];
}

export function formGroupCollectionContent(): FormGroupCollection[] {
  return [
    {
...
export function buttons(): FormButtons {
  return {
    buttons: [
      {
        type: "button",
