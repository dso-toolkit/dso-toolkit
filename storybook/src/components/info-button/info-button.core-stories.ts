...
const { Active, Inactive, SecondaryActive, SecondaryInactive, WithTooltip } = infoButtonStories({
  templateContainer,
...
export { Active, Inactive, SecondaryActive, SecondaryInactive, WithTooltip };
