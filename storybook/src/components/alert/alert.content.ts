...
export function successMessage() {
  return html`<p>Dit is een succesmelding. Deze wordt getoond als een proces succesvol is afgerond.</p>`;
}
...
export function warningMessage() {
  return html`<p>Dit is een waarschuwingsmelding. Deze wordt gebruikt voor waarschuwingen.</p>`;
}
...
export function alertWithHeadingsContent() {
  return html`
    <h2>Dit is een H2</h2>
