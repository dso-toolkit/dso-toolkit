...
import { imageTemplate } from "../image/image.css-template";
...
export const children = html`${richContentTemplate({
  children: html`
    ...
    <p>
      ...
      letterzetting. Het is in de jaren '60 populair geworden met de introductie van Letraset vellen met deze paragraaf
      passages en meer recentelijk door desktop publishing software zoals Aldus PageMaker die versies van deze paragraaf
      bevatten.
    </p>
    <p>
    ...
    <p>
      Richard McClintock, een professor latijn aan de Hampden-Sydney College in Virginia, heeft één van de meer obscure
      latijnse woorden, consectetur, uit een deze paragraaf passage opgezocht, en heeft tijdens het zoeken naar het
      woord in de klassieke literatuur de onverdachte bron ontdekt.
    </p>
