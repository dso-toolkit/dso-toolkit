...
import { datePickerTemplate } from "../date-picker/date-picker.core-template";
  ...
  return html`
    ...
    >
      ...
      <div class="dso-field-container">
        ...
        ${
          formGroup.feedback
            ? html` <span class="form-control-feedback" aria-hidden="true">${iconTemplate(formGroup.feedback)}</span> `
            : nothing
        }
        ${
