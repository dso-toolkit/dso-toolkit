...
import { selectOptionGroupContent, selectOptionsContent } from "./form-group-select.content.js";
...
export function formGroupSelectArgsMapper(a: FormGroupSelectArgs): FormGroupSelect {
  return {
    group: "select",
    id: a.id,
    label: a.label,
