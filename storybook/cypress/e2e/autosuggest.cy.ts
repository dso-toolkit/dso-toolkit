describe("Autosuggest", () => {
  ...
  it("should regexp-escape suggestions", () => {
    ...
    cy.wait(200);
    cy.get("dso-autosuggest.hydrated").find("div[role='listbox']").should("be.visible");
    cy.get("dso-autosuggest.hydrated").find("div[role='option']").should("have.length", 2);
  });
  ...
  it("ArrowDown should select first option", { browser: "!firefox" }, () => {
    ...
    cy.wait(200);
    cy.realPress("ArrowDown");
    cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(0).should("have.attr", "aria-selected", "true");
  });
  ...
  it("ArrowUp should select last option", { browser: "!firefox" }, () => {
    ...
    cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(9).should("have.attr", "aria-selected", "true");
  });
  ...
  it("should mark terms in options", () => {
    ...
    cy.wait(200);
    cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(0).find("mark").as("mark");
  ...
  it("should ignore space after terms while marking terms", () => {
    ...
    cy.wait(200);
    cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(0).find("mark").eq(0).should("contain", "U");
  });

  it("should show type in options", () => {
    cy.get("input").focus().type("rotterdam");
    cy.wait(200);
    cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(0).should("not.contain", "adres in Rotterdam");
  ...
  it("should pass supplied object to dsoSelect event", () => {
    ...
    cy.get("input").focus().type("rotterdam");
    cy.wait(200);
    cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(3).trigger("mouseenter").click();
  ...
  it("should show not found text in Dutch when no results are found", () => {
    ...
    cy.get("dso-autosuggest.hydrated").find("div[role='listbox']").should("be.visible");
    cy.get("dso-autosuggest.hydrated")
      .find("div[role='listbox'] div span mark")
      .should("be.visible")
      .contains("akjehfowef");
    cy.get("dso-autosuggest.hydrated")
      .find("div[role='listbox'] div span")
      .should("be.visible")
  ...
  it("should mark suggestion based on consumer provided AutosuggestMarkItems", () => {
    ...
    cy.get("dso-autosuggest.hydrated")
      .find("div[role='option'] .suggestion-row .value")
      .should("contain", "evingsplan gemeente Groningen");

    cy.get("dso-autosuggest.hydrated").find("div[role='option'] .suggestion-row .value mark").should("contain", "Omg");

    cy.get("dso-autosuggest.hydrated")
      .find("div[role='option'] .suggestion-row .type")
      .should("contain", "evingsplan (")
      .and("contain", "evingswet)");
    cy.get("dso-autosuggest.hydrated").find("div[role='option'] .suggestion-row .type mark").should("contain", "omg");

    cy.get("dso-autosuggest.hydrated")
      .find("div[role='option'] .suggestion-row .extra")
      .should("contain", "Ontwerp ")
      .and("contain", "01-2024");
    cy.get("dso-autosuggest.hydrated").find("div[role='option'] .suggestion-row .extra mark").should("contain", "18-");

    cy.get("dso-autosuggest.hydrated")
      .find("div[role='option'] .suggestion-row .extra")
      .should("contain", "gemeente Gron")
      .and("contain", "en");
    cy.get("dso-autosuggest.hydrated").find("div[role='option'] .suggestion-row .extra mark").should("contain", "ing");

    cy.get("dso-autosuggest.hydrated")
      .find("div[role='option'] .suggestion-row .extra")
      .should("contain", "/akn/nl/act/gm0014/2020/")
      .and("contain", "evingsplan");
    cy.get("dso-autosuggest.hydrated").find("div[role='option'] .suggestion-row .extra mark").should("contain", "omg");
  });
  ...
  describe("with grouped items", () => {
    ...
    it("shows suggestions after input", () => {
      cy.get("dso-autosuggest.hydrated").find("div[role='listbox']").should("not.exist");
      cy.dsoCheckA11y("dso-autosuggest.hydrated");
      ...
      cy.get("dso-autosuggest.hydrated").find("div[role='listbox']").should("be.visible");
      cy.dsoCheckA11y("dso-autosuggest.hydrated");
      cy.get("dso-autosuggest.hydrated").find("div[role='group']").should("have.length", 3);
      cy.get("dso-autosuggest.hydrated").find("div[role='option']").should("have.length", 7);
    ...
    it("ArrowUp selects last option", { browser: "!firefox" }, () => {
      cy.get("input").focus().type("groep");
      cy.wait(200);
      cy.realPress("ArrowUp");
      cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(6).should("have.attr", "aria-selected", "true");
    });
    ...
    it("ArrowDown and ArrowUp skips group labels", () => {
      ...
      cy.realPress("ArrowDown");
      cy.realPress("ArrowDown");
      cy.get("dso-autosuggest.hydrated").find("div[role='option']").eq(3).should("have.attr", "aria-selected", "true");
      cy.realPress("ArrowUp");
