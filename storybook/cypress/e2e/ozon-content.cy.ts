...
describe("Ozon Content", () => {
  ...
  describe("IntIoRef", () => {
    ...
    it("emits click with node='IntIoRef' on clicking the 'Officiële publicaties' Link ", () => {
      cy.get("dso-ozon-content.hydrated")
        .shadow()
        .find("dso-reference-toggletip")
        .shadow()
      ...
      cy.get("dso-ozon-content.hydrated")
        .shadow()
        .find('dso-reference-toggletip a[href = "gm0037_1__cmp_I__content_1__list_o_1__item_o_1__ref_o_1"]')
        .realClick();
    ...
    it("emits click with node='IntIoRefAnnotation' on clicking the 'Gebieden op de kaart tonen' Button ", () => {
      cy.get("dso-ozon-content.hydrated")
        .shadow()
        .find("dso-reference-toggletip")
        .shadow()
      ...
      cy.get("@click")
        ...
        .invoke("getCall", 0)
        .its("args.0.detail.node")
        .should("equal", "IntIoRefAnnotation");
    });
  });
