describe("Pagination", () => {
  ...
  describe("with totalPages", () => {
    it("should show 5 pages and previous and next buttons", () => {
      ...
      cy.get("dso-pagination")
        .shadow()
        .as("dsoPagination")
        .find(".pagination > ul > li")
        .should("have.length", 7)
        .get("@dsoPagination")
        .find('a[aria-label="Vorige pagina"]')
        .should("be.visible")
        .get("@dsoPagination")
  ...
  describe("without totalPages", () => {
    it("should show 4 pages and previous and next buttons", () => {
      prepareComponent(5, null);
