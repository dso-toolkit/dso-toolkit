...
* Card: property `rectangularImage`. Deze property zet de class `dso-img-rectangle` op `img[slot="image"]`. Deze class kan ook direct op het slot element worden geplaatst ([#2059](https://github.com/dso-toolkit/dso-toolkit/issues/2059))
