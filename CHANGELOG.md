...
### Changed
* Angular: Signal Forms-ondersteuning voor Date Picker en Selectable ([#3993](https://github.com/dso-toolkit/dso-toolkit/issues/3993))
...
* Shopping Cart: Sluiten knop met cross ipv. chevron-right ([#3976](https://github.com/dso-toolkit/dso-toolkit/issues/3976))
...
* Advanced Select: Truncate verwijderen en multiline aanbieden ([#3910](https://github.com/dso-toolkit/dso-toolkit/issues/3910))
...
### Removed
* **BREAKING** Toggletip: Remove ([#3399](https://github.com/dso-toolkit/dso-toolkit/issues/3399))
...
* **BREAKING** Packages: Dependencies updates ([#3480](https://github.com/dso-toolkit/dso-toolkit/issues/3480))
...
* Accordion: Deprecate HTML/CSS implementatie ([#3266](https://github.com/dso-toolkit/dso-toolkit/issues/3266))
...
### Changed
* **BREAKING** Dropdown Menu: Popperjs deprecated ([#2457](https://github.com/dso-toolkit/dso-toolkit/issues/2457))

### Removed
* **BREAKING** Pagination: Verwijderen HTML/CSS component ([#2868](https://github.com/dso-toolkit/dso-toolkit/issues/2868))
...
* Angular: Karma testrunner error in @stencil/core/internal/client/index.js ([#3100](https://github.com/dso-toolkit/dso-toolkit/issues/3100))
* **BREAKING** Document Component: Kop werkt niet goed ([#3110](https://github.com/dso-toolkit/dso-toolkit/issues/3110))
...
### Fixed
* Autosuggest: memory leak ([#3085](https://github.com/dso-toolkit/dso-toolkit/issues/3085))
...
### Changed
* Verticaal Ritme: aanpassing ruimte tussen contactinformatie blokken ([#3012](https://github.com/dso-toolkit/dso-toolkit/issues/3012))
...
* Icon: Visuele regressietest ([#2938](https://github.com/dso-toolkit/dso-toolkit/issues/2938))
...
* Alert: Nieuwe optie "closable" ([#2745](https://github.com/dso-toolkit/dso-toolkit/issues/2745))
...
### Task
* Packages: Dependencies updates ([#2921](https://github.com/dso-toolkit/dso-toolkit/issues/2921))
...
### Changed
* Icon Mixins: Icon Mixins: Spritesheet dso-icons.svg opknippen ([#2844](https://github.com/dso-toolkit/dso-toolkit/issues/2844))
...
* Ozon Content: flaky e2e test ([#2789](https://github.com/dso-toolkit/dso-toolkit/issues/2789))
...
* Project Item: Nieuw component ([#2779](https://github.com/dso-toolkit/dso-toolkit/issues/2779))

### Changed
* Document Component: Panel heading wordt "Kenmerken en kaart" ([#2798](https://github.com/dso-toolkit/dso-toolkit/issues/2798))

### Fixed
* Mark Bar: Pointer on empty field button ([#2806](https://github.com/dso-toolkit/dso-toolkit/issues/2806))
* Autosuggest: Onzichtbare suggestielijst blokkeert onderliggende elementen ([#2801](https://github.com/dso-toolkit/dso-toolkit/issues/2801))
...
* Build: AXE verwerken in buildstraat voor toegankelijkheid componenten ([#1988](https://github.com/dso-toolkit/dso-toolkit/issues/1988))
...
### Tasks
* Build: GitHub releases aansluiten ([#2589](https://github.com/dso-toolkit/dso-toolkit/issues/2589))

## 🧃 Release 62.28.0 - 15-07-2024
...
### Tasks
* Packages: Dependencies updates ([#2686](https://github.com/dso-toolkit/dso-toolkit/issues/2686))
...
### Added
* Form Group Files: Ondersteuning voor een spinner (progress indicator) tijdens upload van bestand ([#2616](https://github.com/dso-toolkit/dso-toolkit/issues/2616))
...
### Fixed
* Dropdown Menu: Werkt niet in ShadowRoot ([#2585](https://github.com/dso-toolkit/dso-toolkit/issues/2585))
...
* Toggletip: Wordt niet getoond bij position: bottom ([#2477](https://github.com/dso-toolkit/dso-toolkit/issues/2477))
...
* Action List: Rich content align ([#2544](https://github.com/dso-toolkit/dso-toolkit/issues/2544))
...
* Anchor: Ondersteuning voor `tel:` en `mailto:` ([#2351](https://github.com/dso-toolkit/dso-toolkit/issues/2351))

### Fixed
* Build: SCSS compileert niet meer ([#2452](https://github.com/dso-toolkit/dso-toolkit/issues/2452))

## 🚦 62.3.3 - 29-11-2023 (Upstream merge)
...
* Date Picker: Output date als dd-mm-jjjj ([#2391](https://github.com/dso-toolkit/dso-toolkit/issues/2391))
...
### Added
* **BREAKING** Viewer Grid: VDK layout ([#2161](https://github.com/dso-toolkit/dso-toolkit/issues/2161))
...
* Expandable Heading: `suppressed` modus ([#2175](https://github.com/dso-toolkit/dso-toolkit/issues/2175))
...
### Added
* dsoToggle event voor Annotation Output, Expandable en Expandable Heading niet bubblen ([#2166](https://github.com/dso-toolkit/dso-toolkit/issues/2166))
...
* Date picker: grijs maken van disabled dagen voor en na de huidige maand ([#2039](https://github.com/dso-toolkit/dso-toolkit/issues/2039))
