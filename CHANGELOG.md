...
### Fixed
* **BREAKING: core + css + react + sources:** Niet alle event-emitters werken in de react storybook ([#1706](https://github.com/dso-toolkit/dso-toolkit/issues/1706)) **Custom event properties hebben een dso prefix gekreken ([#1789](https://github.com/dso-toolkit/dso-toolkit/pull/1789))**
