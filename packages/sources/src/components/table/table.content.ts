...
export const defaultTable = {
  ...
  rows: [
    ...
    ['3', '<a href="#taylor">Taylor</a>', 'Otwell', 'taylorotwell', '<code>tr</code>', 'eenhelelangekolomdienietbreekt'],
    ['4', '<a href="#kitty">Kitty</a>', 'Giraudel', 'KittyGiraudel', '<code>tr</code>', 'eenhelelangekolomdienietbreekt'],
  ],
};
