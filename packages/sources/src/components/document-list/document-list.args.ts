...
export function documentListMapper<TemplateFnReturnType>(demoMapper: ({ badge, date }: DocumentListItemStatusDemoContent) => TemplateFnReturnType): DocumentList<TemplateFnReturnType> {
  return {
