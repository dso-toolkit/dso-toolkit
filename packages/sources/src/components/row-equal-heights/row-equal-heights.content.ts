...
export const highlightBoxes: HighlightBox<string>[] = [
  {
    ...
    dropShadow: false,
    step: 1,
    content: '<div class="dso-rich-content"><h2>Ongelijke inhoud</h2><p>Dit blok is hoger, dit blok heeft meer te vertellen omdat het een veel boeiender blok is. Mijn broertjes zijn minder interessant, dat zie je aan de inhoud.</p><p>PS: Ik ben het tweede blokje</p></div>'
  },
  {
    yellow: false,
    white: false,
    ...
    dropShadow: false,
    step: 2,
    content: '<div class="dso-rich-content"><h2>Ongelijke inhoud</h2><p>een <code>.row</code> een <code>.dso-equal-heights</code> krijgt, worden voor de volgende componenten de kolommen visueel even hoog:</p><ul><li>Highlight Box</li><li>Whitebox</li><li>Whitebox small</li></ul></div>'
  },
  {
    yellow: false,
    white: false,
