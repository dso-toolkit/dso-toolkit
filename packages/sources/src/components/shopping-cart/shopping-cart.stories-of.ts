...
export function storiesOfShoppingCart<Implementation, Templates, TemplateFnReturnType>(storiesOfArguments: StoriesOfArguments<Implementation, Templates, TemplateFnReturnType, ShoppingCartTemplates<TemplateFnReturnType>>) {
  return storiesOfFactory('Shopping Cart', storiesOfArguments, (stories, templateMapper) => {
    ...
    const template = templateMapper<ShoppingCartArgs>((args, { shoppingCartTemplate }) => shoppingCartTemplate(shoppingCartArgsMapper(args)));
