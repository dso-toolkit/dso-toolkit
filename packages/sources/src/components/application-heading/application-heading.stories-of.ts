...
export function storiesOfApplicationHeading<Implementation, Templates, TemplateFnReturnType>(storiesOfArguments: StoriesOfArguments<Implementation, Templates, TemplateFnReturnType, ApplicationHeadingTemplates<TemplateFnReturnType>>) {
  return storiesOfFactory('Application Heading', storiesOfArguments, (stories, templateMapper) => {
    ...
    const template = templateMapper<ApplicationHeadingArgs>((args, { applicationHeadingTemplate }) => applicationHeadingTemplate(applicationHeadingArgsMapper(args)));
