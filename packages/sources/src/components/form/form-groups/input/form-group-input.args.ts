...
import { FormGroupInput, FormGroupInputDate } from '../../form.models';
...
export function formGroupInputArgsMapper(a: FormGroupInputArgs): FormGroupInput<any> | FormGroupInputDate<any> {
  return {
    group: 'input',
    type: a.type,
    id: a.id,
