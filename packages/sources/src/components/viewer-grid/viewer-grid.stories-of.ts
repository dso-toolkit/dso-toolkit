...
export const storiesOfViewerGrid = storiesOfFactory<ViewerGridTemplates<any>, ViewerGridArgs>('Viewer Grid', (stories, templateMapper) => {
  ...
  stories.add(
    'Viewer Grid',
    templateMapper((args, { viewerGridTemplate, example }) => viewerGridTemplate({
