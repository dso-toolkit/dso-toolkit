...
export function storiesOfDatePicker<Implementation, Templates, TemplateFnReturnType>(
  storiesOfArguments: StoriesOfArguments<Implementation, Templates, TemplateFnReturnType, DatePickerTemplates<TemplateFnReturnType>>,
  ...
  return storiesOfFactory('Date Picker', storiesOfArguments, (stories, templateMapper) => {
    ...
    const template = templateMapper<DatePickerArgs>((args, { datePickerTemplate }) => datePickerTemplate(datePickerArgsMapper(args)));
