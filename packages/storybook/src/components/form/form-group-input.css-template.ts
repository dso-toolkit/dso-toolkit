...
export const cssFormGroupInput: ComponentImplementation<FormGroupInput<TemplateResult> | FormGroupInputDate<TemplateResult>> = {
  component: 'formGroupInput',
  implementation: 'css',
  template: ({ infoButtonTemplate, infoTemplate, datePickerTemplate, iconTemplate }) => function formGroupInputTemplate(formGroup) {
