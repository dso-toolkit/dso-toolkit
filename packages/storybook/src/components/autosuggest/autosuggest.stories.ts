  ...
  storyTemplates: ({ autosuggestTemplate }) => {
    ...
    return ({
      autosuggestDemoTemplate: (fetchSuggestions, dsoSelect, dsoChange, dsoSearch, suggestOnFocus, loading, loadingLabel, loadingDelayed, notFoundLabel, minimalCharacters) => html`
        ...
        ${autosuggestTemplate(autosuggestConnector([fetchSuggestions, dsoSelect, dsoChange, dsoSearch, suggestOnFocus, loading, loadingLabel, loadingDelayed, notFoundLabel, minimalCharacters]))}
