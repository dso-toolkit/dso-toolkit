                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-right">
                      ...
                      <!-- een TOOLTIP in een button.. hoe doen we dat? -->
                      <!-- {% render '@button', {label:'Boomkappen in de achtertuin aanpassen', type:'button',
                      modifier:'dso-tertiary', icon:'pencil', iconOnly: true, tooltip: {label: 'Projectnaam bewerken',
                      position: 'top'} } %} {% render '@button', {label:'Boomkappen in de achtertuin verwijderen',
                      type:'button', modifier:'dso-tertiary', icon:'trash', iconOnly: true, tooltip: {label:
                      'Verwijderen', position: 'top'} } %} -->
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-right">
                      ...
                      <!-- een TOOLTIP in een button.. hoe doen we dat? -->
                      <!-- {% render '@button', {label:'Project 9 aanpassen', type:'button', modifier:'dso-tertiary',
                      icon:'pencil', iconOnly: true, tooltip: {label: 'Projectnaam bewerken', position: 'top'} } %} {%
                      render '@button', {label:'Project 9 verwijderen', type:'button', modifier:'dso-tertiary',
                      icon:'trash', iconOnly: true, tooltip: {label: 'Verwijderen', position: 'top'} } %} -->
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-right">
                      ...
                      <!-- een TOOLTIP in een button.. hoe doen we dat? -->
                      <!-- {% render '@button', {label:'Project 8 aanpassen', type:'button', modifier:'dso-tertiary',
                      icon:'pencil', iconOnly: true, tooltip: {label: 'Projectnaam bewerken', position: 'top'} } %} {%
                      render '@button', {label:'Project 8 verwijderen', type:'button', modifier:'dso-tertiary',
                      icon:'trash', iconOnly: true, tooltip: {label: 'Verwijderen', position: 'top'} } %} -->
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-right">
                      ...
                      <!-- een TOOLTIP in een button.. hoe doen we dat? -->
                      <!-- {% render '@button', {label:'Project 7 aanpassen', type:'button', modifier:'dso-tertiary',
                      icon:'pencil', iconOnly: true, tooltip: {label: 'Projectnaam bewerken', position: 'top'} } %} {%
                      render '@button', {label:'Project 7 verwijderen', type:'button', modifier:'dso-tertiary',
                      icon:'trash', iconOnly: true, tooltip: {label: 'Verwijderen', position: 'top'} } %} -->
                    </td>
                  </tr>
                </tbody>
