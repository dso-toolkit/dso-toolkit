      ...
      <main>
        <div class="row dso-banner dso-banner-implementation-specific-image" style="background-image: url('images/hands-on-trackpad.jpg')">
          <div class="col-lg-6 col-sm-8">
            ${highlightBoxTemplate({ white: true, content: html`
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ${highlightBoxTemplate({ border: true, white: true, content: html`
              <div class="dso-rich-content">
                <h2>Vragen?</h2>
          ...
          <div class="col-xs-12">
            ...
            <div class="row dso-equal-heights">
              <div class="col-md-3 col-sm-6">
                ${highlightBoxTemplate({ white: true, dropShadow: true, step: 1, content: html`
                  <div class="dso-rich-content">
              ...
              <div class="col-md-3 col-sm-6">
                ${highlightBoxTemplate({ white: true, dropShadow: true, step: 2, content: html`
                  <div class="dso-rich-content">
                    <h3>Locatie</h3>
              ...
              <div class="col-md-3 col-sm-6">
                ${highlightBoxTemplate({ white: true, dropShadow: true, step: 3, content: html`
                  <div class="dso-rich-content">
                    <h3>Activiteiten</h3>
              ...
              <div class="col-md-3 col-sm-6">
                ${highlightBoxTemplate({ white: true, dropShadow: true, step: 4, content: html`
                  <div class="dso-rich-content">
            ...
            <div class="row dso-equal-heights">
              <div class="col-md-3 col-sm-6">
                ${highlightBoxTemplate({ white: true, dropShadow: true, step: 5, content: html`
                  <div class="dso-rich-content">
              ...
              <div class="col-md-3 col-sm-6">
                ${highlightBoxTemplate({ white: true, dropShadow: true, step: 6, content: html`
                  <div class="dso-rich-content">
                    <h3>Uw gegevens</h3>
              ...
              <div class="col-md-3 col-sm-6">
                ${highlightBoxTemplate({ white: true, dropShadow: true, step: 7, content: html`
                  <div class="dso-rich-content">
