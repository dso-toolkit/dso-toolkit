    ...
    <div class="container">
      ...
      <main>
        ...
        <div class="dso-rich-content">
          ...
          <p>
            See also:
            ${anchorTemplate({ label: 'Timeline of The Hague', url: 'https://en.wikipedia.org/wiki/Timeline_of_The_Hague', modifier: 'extern' })}
          </p>
          ...
          <p>
            See ${anchorTemplate({ label: 'Wikipedia', url: 'https://en.wikipedia.org/wiki/The_Hague', modifier: 'extern' })}
          </p>
