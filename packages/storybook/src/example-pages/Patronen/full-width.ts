  ...
  ({ definitionListTemplate, listTemplate, tableTemplate, anchorTemplate }, templates) => html`
    <div class="container">
      ...
      <main>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="dso-rich-content">${listTemplate(listGroup)}</div>
          </div>
          <div class="col-md-6">
            ${tableTemplate({
              noModal: true,
        ...
        <div class="dso-rich-content">
          ...
          <p>
            The city sustained heavy damage during World War II. Many Jews were killed during the German occupation.
            Additionally, the Atlantic Wall was built through the city, causing a large quarter to be torn down by the
            Nazi occupants. On 3 March 1945, the Royal Air Force mistakenly bombed the Bezuidenhout quarter. The target
            was an installation of V-2 rockets in the nearby Haagse Bos park, but because of navigational errors, the
            bombs fell on a heavily populated and historic part of the city. The bombardment wreaked widespread
            destruction in the area and caused 511 fatalities.
          </p>
          <h5>More information (h5)</h5>
          <p>
            See
