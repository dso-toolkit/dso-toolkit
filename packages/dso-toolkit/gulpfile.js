...
import { buildDiSvgSpritesheet } from "./gulp/build-svg-spritesheets.js";
...
gulp.task("build", gulp.series(cleanDist, gulp.parallel(copyMiscellaneous, buildStyling, buildDiSvgSpritesheet)));
