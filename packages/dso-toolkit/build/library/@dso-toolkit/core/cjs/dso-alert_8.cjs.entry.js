...
const Alert = class {
  ...
  render() {
    ...
    return (index.h("div", { class: clsx('alert', `alert-${this.status}`), role: "alert" }, index.h("span", { class: "sr-only" }, status, ":"), index.h("slot", null)));
  }
};
...
const Badge = class {
  ...
  render() {
    return (index.h("span", { class: clsx('dso-badge', { [`badge-${this.status}`]: this.status }) }, index.h("span", { class: "sr-only" }, this.status ? Badge.statusMap.get(this.status) : 'Badge', ": "), index.h("slot", null)));
  }
};
...
const HighlightBox = class {
  ...
  render() {
    ...
    return (index.h("div", { class: classes }, hasCounter && (index.h("div", { class: "dso-step-counter" }, (_a = this.step) !== null && _a !== void 0 ? _a : (index.h("slot", { name: "icon" })))), index.h("slot", null)));
  }
...
const Icon = class {
  ...
  render() {
    return (index.h("svg", { class: clsx('di', this.icon) }, index.h("use", { href: `${index.getAssetPath('./icon-assets/dso-icons.svg')}#${this.icon}` })));
  }
...
const Label = class {
  ...
  render() {
    ...
    return (index.h("span", { class: clsx('dso-label', { [`dso-label-${this.status}`]: this.status }) }, status && (index.h("span", { class: "sr-only" }, status, ": ")), index.h("slot", null), index.h("slot", { name: "action" })));
  }
};
...
const ProgressBar = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "progress" }, index.h("div", { class: "progress-bar", role: "progressbar", "aria-valuenow": progress, "aria-valuemin": this.min, "aria-valuemax": this.max, style: { width: `${progress}%` } }, index.h("span", null, index.h("slot", null, `${progress}%`)))));
  }
};
...
const WhiteBox = class {
  ...
  render() {
    ...
    return (index.h("div", { class: classes }, hasCounter && (index.h("div", { class: "dso-step-counter" }, (_a = this.step) !== null && _a !== void 0 ? _a : (index.h("slot", { name: "icon" })))), this.small ? (index.h("a", { href: "#" }, index.h("span", { class: "dso-whitebox-icon" }, index.h("slot", { name: "img" })), index.h("span", { class: "dso-whitebox-link" }, this.label))) : (index.h("p", null, "ik ben groot"))));
  }
  get element() { return index.getElement(this); }
};
WhiteBox.style = whiteboxCss;
...
exports.dso_icon = Icon;
exports.dso_label = Label;
exports.dso_progress_bar = ProgressBar;
exports.dso_whitebox = WhiteBox;
