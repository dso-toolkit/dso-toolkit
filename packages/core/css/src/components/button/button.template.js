...
function anchorElement({ url, label, modifier, id, icon, iconMode, slot }) {
  return html `
    <a
      href=${url}
...
function buttonElement({ variant, label, type, modifier, id, disabled, icon, iconMode, ariaDescribedby, ariaExpanded, ariaHaspopup, ariaRoledescription, onClick, slot }) {
  ...
  return html `
    <button
      ...
      aria-haspopup=${ifDefined(ariaHaspopup === null || ariaHaspopup === void 0 ? void 0 : ariaHaspopup.toString())}
