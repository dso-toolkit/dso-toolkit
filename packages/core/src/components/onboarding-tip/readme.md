...
<!-- src/components/onboarding-tip/onboarding-tip.interfaces.ts::OnboardingTipCloseEvent -->

### OnboardingTipPlacement

```typescript
export type OnboardingTipPlacement = "top" | "right" | "bottom" | "left";
```

<!-- src/components/onboarding-tip/onboarding-tip.interfaces.ts::OnboardingTipPlacement -->
