...
| ---------------- | ----------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | ----------- |
| `begripResolver` | `begrip-resolver` | A BegripResolver that will be called for STOP element "IntRef" with                                             | `OzonContentBegripResolver \| undefined`                          | `undefined` |
...
| --------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dsoClick`                        | Emitted when an interactive element is clicked. | `CustomEvent<OzonContentClickBaseEvent<"ExtRef"> \| OzonContentClickBaseEvent<"IntIoRef"> \| OzonContentClickBaseEvent<"IntIoRefAnnotation"> \| OzonContentClickBaseEvent<"IntRef"> \| OzonContentClickBaseEvent<"Kop">>` |
