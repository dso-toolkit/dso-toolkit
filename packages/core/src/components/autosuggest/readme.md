...
| `mark`           | --                | A function provided by the consumer of the autosuggest component, that returns an array of `AutosuggestMarkItem`s                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `((suggestion: Suggestion, text: string, type: "type" \| "value" \| "extra", extraIndex?: number \| undefined) => AutosuggestMarkItem[]) \| undefined` | `undefined`            |
