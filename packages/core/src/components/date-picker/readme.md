...
| -------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------- | ----------- |
| `describedBy`  | `described-by`  | Is input to be described by?                                                                                                                                                                                                   | `string \| undefined`  | `undefined` |
...
| `dsoDateChange` | Event emitted when a date is selected.              | `CustomEvent<{ component: "dso-date-picker"; valueAsDate: Date \| undefined; value: string; error?: "required" \| "invalid" \| "min-range" \| "max-range" \| undefined; }>` |
