...
| `describedById`     | `described-by-id` | To link this control to the Info that describes it. The property `infoFixed` should be set to true. The slot `info` should be filled.  Implemented with `aria-describedby` on the `<input>` element; works alongside `errormessage`. | `string \| undefined`   | `undefined` |
| `disabled`          | `disabled`        | To disable the Selectable.                                                                                                                                                                                                           | `boolean \| undefined`  | `undefined` |
| `errormessage`      | `errormessage`    | To link this control to an element containing an error message.  The value is the id of the element containing the error message. Implemented with `aria-describedby` on the `<input>` element; works alongside `describedById`.     | `string \| undefined`   | `undefined` |
...
| `value`             | `value`           | The value of the Selectable.                                                                                                                                                                                                         | `string \| undefined`   | `undefined` |
