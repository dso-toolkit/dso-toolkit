...
| `icon`                     | `icon`                 | The alias of the icon in the heading handle.                                                                                                                                                                                        | `IconAlias \| undefined`                                                                                                                       | `undefined` |
| `label`                    | `label`                | The label to be displayed in the heading handle inside a Label (optional)                                                                                                                                                           | `string \| undefined`                                                                                                                          | `undefined` |
| `labelStatus`              | `label-status`         | The status of the Label in the heading handle (optional)                                                                                                                                                                            | `"attention" \| "bright" \| "error" \| "filter" \| "info" \| "primary" \| "success" \| "toegevoegd" \| "verwijderd" \| "warning" \| undefined` | `undefined` |
