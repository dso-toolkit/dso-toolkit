...
| `variant`      | `variant` | Variant determines the icon and actions shown. Allowed values: "success", "error", "introduction". Default is "introduction". | `"error" \| "introduction" \| "success"` | `"introduction"` |
