...
| `mark`                      | `mark`                         | To mark text.                                                                                                                                                                                             | `((text: string, source: DocumentComponentSource) => MarkTextText[]) \| undefined`   | `undefined`  |
...
| `ozonContentBegripResolver` | `ozon-content-begrip-resolver` | A BegripResolver that will be called for STOP element "IntRef". If the ref-attribute of IntRef points to a Begrip it should return the `<Definitie>` of that Begrip otherwise it should return undefined. | `OzonContentBegripResolver \| undefined`                                             | `undefined`  |
