...
| `label`                    | `label`                      | <span style="color:red">**[DEPRECATED]**</span> Use `kop` instead.<br/><br/>The Label XML.                        | `XMLDocument \| string \| undefined`                                                  | `undefined`  |
...
| `nummer`                   | `nummer`                     | <span style="color:red">**[DEPRECATED]**</span> Use `kop` instead.<br/><br/>The Nummer XML.                       | `XMLDocument \| string \| undefined`                                                  | `undefined`  |
...
| `opschrift`                | `opschrift`                  | <span style="color:red">**[DEPRECATED]**</span> Use `kop` instead.<br/><br/>The Opschrift XML.                    | `XMLDocument \| string \| undefined`                                                  | `undefined`  |
