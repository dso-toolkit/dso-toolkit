...
| `heading`                   | `heading`                 | The heading element to use (only in mode="document"). In mode="table-of-contents" the nested lists carry the structure and no heading is rendered.                                                        | `"h2" \| "h3" \| "h4" \| "h5" \| "h6"`                                                                                                                                                                                                                                                                                                                             | `"h2"`       |
...
| `type` _(required)_         | `type`                    | Type of Document Component.                                                                                                                                                                               | `"AANHEF" \| "AFDELING" \| "ALGEMENE_TOELICHTING" \| "ARTIKEL" \| "ARTIKELGEWIJZE_TOELICHTING" \| "BEGRIP" \| "BIJLAGE" \| "BOEK" \| "CONDITIE_ARTIKEL" \| "DEEL" \| "DIVISIE" \| "DIVISIETEKST" \| "HOOFDSTUK" \| "LICHAAM" \| "LID" \| "PARAGRAAF" \| "SLUITING" \| "SUBPARAGRAAF" \| "SUBSUBPARAGRAAF" \| "TITEL" \| "TITELDEEL" \| "TOELICHTING" \| undefined` | `undefined`  |
