...
| `dsoPanelSwitch` | Emitted when a navbar item is pressed. The `detail` property of the `CustomEvent` will contain the text of the anchor. | `CustomEvent<LegendNavbarClickEvent>` |
