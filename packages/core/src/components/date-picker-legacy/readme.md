...
| `dsoDateChange` | Event emitted when a date is selected.              | `CustomEvent<{ component: "dso-date-picker-legacy"; valueAsDate: Date \| undefined; value: string; error?: "required" \| "invalid" \| "min-range" \| "max-range" \| undefined; }>` |
