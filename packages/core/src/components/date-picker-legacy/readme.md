...
Beware: This component is no part of the public API of the DSO Toolkit. If you're starting with Date Pickers, take a look at `<dso-date-picker>`. This component is only here for legacy reasons, hence the name "Date Picker Legacy".
...
| --------------- | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dsoBlur`       | Event emitted the date picker input is blurred.     | `CustomEvent<{ component: "dso-date-picker-legacy"; }>`                                                                                                                            |
| `dsoDateChange` | Event emitted when a date is selected.              | `CustomEvent<{ component: "dso-date-picker-legacy"; valueAsDate: Date \| undefined; value: string; error?: "required" \| "min-range" \| "max-range" \| "invalid" \| undefined; }>` |
