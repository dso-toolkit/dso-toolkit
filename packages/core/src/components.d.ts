...
export { LegendCloseEvent, LegendNavbarClickEvent, NavbarItem } from "dso-toolkit";
...
declare global {
    ...
    interface HTMLDsoLegendElementEventMap {
        "dsoPanelSwitch": LegendNavbarClickEvent;
...
declare namespace LocalJSX {
    ...
    interface DsoLegend {
         ...
         */
        "onDsoPanelSwitch"?: (event: DsoLegendCustomEvent<LegendNavbarClickEvent>) => void;
    }
    interface DsoLegendItem {
        /**
          * Controls whether this Legend Item can be active or not
