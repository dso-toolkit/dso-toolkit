...
export function dynamicContent({ accordionTemplate }: Templates) {
  return (
    <>
      <div>
        <p>
          Het Omgevingsloket is een gezamenlijk initiatief van het Ministerie van Volkshuisvesting en Ruimtelijke
          Ordening (VRO), gemeenten, provincies en waterschappen. Hier kunnen gebruikers vergunningaanvragen indienen,
          meldingen doen en informatie opvragen over de fysieke leefomgeving.
        </p>
      </div>
      {accordionTemplate({
        variant: "compact",
