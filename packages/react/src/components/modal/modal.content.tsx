...
export const fullscreenBody = (
  <>
    <h1>Introductie</h1>
    <blockquote>
      <p>De DSO Toolkit: wat is het, voor wie is het en hoe werkt het?</p>
    </blockquote>
    <p>
    ...
    <h2 className="anchor anchorWithStickyNavbar_JmGV" id="waar-kan-de-dso-toolkit-mij-bij-helpen">
    ...
    <ul className="">
      <li>
        <a href="/58.3.1/voor-developers">Developers</a>
      </li>
      <li>
        <a href="/58.3.1/voor-designers">Ontwerpers</a>
      </li>
      <li>
        <a href="/58.3.1/voor-productowners">Product owners</a>
      </li>
    </ul>
    <h3 className="anchor anchorWithStickyNavbar_JmGV" id="slack">
      Slack
      <a href="#slack" className="hash-link" aria-label="Direct link naar Slack" title="Direct link naar Slack">
        &ZeroWidthSpace;
      </a>
    </h3>
    ...
    <h2 className="anchor anchorWithStickyNavbar_JmGV" id="digitale-toegankelijkheid">
    ...
    <p>
      ...
      website van
      <a href="https://www.digitoegankelijk.nl" target="_blank" rel="noopener noreferrer">
        digitoegankelijk.nl
      </a>{" "}
      legt uit waarom dit zo belangrijk is:
    </p>
    <blockquote>
      <p>
    ...
    <p>
      ...
      <a href="https://www.w3.org/TR/WCAG21/" target="_blank" rel="noopener noreferrer">
        Web Content Accessibility Guidelines (WCAG) versie 2.1
      </a>
    ...
    <h2 className="anchor anchorWithStickyNavbar_JmGV" id="disclaimer">
      Disclaimer
      <a
        href="#disclaimer"
        className="hash-link"
