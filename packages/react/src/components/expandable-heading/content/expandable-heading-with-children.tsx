      ...
      <ol>
        <li>
          <div style={{ float: "right", marginLeft: "8px" }}>
            {annotationButtonTemplate({ identifier: `annotatie-list-${key}` })}
          </div>
          <div>
...
function nestedExpandableHeading1(templates: Templates, editAction?: EditAction) {
  ...
  return {
    title: ozonContentTemplate({
      ...
      dsoAnchorClick: () => void 0,
      dsoClick: () => void 0,
      prefix: <span slot="prefix">Afdeling 2.1 </span>,
      inline: true,
    }),
    editAction,
    content: (
        ...
        {[1, 2, 3].map((article) =>
          expandableHeadingTemplate({
            ...
            title: ozonContentTemplate({
              ...
              dsoAnchorClick: () => void 0,
              dsoClick: () => void 0,
              prefix: <span slot="prefix">Artikel 2.1.{article} </span>,
              inline: true,
            }),
...
function nestedExpandableHeading3(templates: Templates, editAction?: EditAction) {
  ...
  return {
    title: ozonContentTemplate({
      ...
      dsoAnchorClick: () => void 0,
      dsoClick: () => void 0,
      prefix: <span slot="prefix">Afdeling 2.3 </span>,
      inline: true,
    }),
    editAction,
...
export function expandableHeadingWithChildList(templates: Templates, renvooi = false): ExpandableHeading<JSX.Element> {
  ...
  return {
    title: ozonContentTemplate({
      ...
      dsoAnchorClick: () => void 0,
      dsoClick: () => void 0,
      prefix: <span slot="prefix">Hoofdstuk 2 </span>,
      inline: true,
    }),
