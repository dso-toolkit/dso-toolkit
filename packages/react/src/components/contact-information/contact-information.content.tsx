...
export const content: ContactInformation = {
  heading: "Gemeente Utrecht",
  anchors: [
    ...
    { label: "Online contactformulier", url: "http://www.google.nl", icon: { icon: "external-link" }, mode: "extern" },
