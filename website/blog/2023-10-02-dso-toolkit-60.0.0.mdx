...
In [#2226](https://github.com/dso-toolkit/dso-toolkit/issues/2226) is de maatwerk Date Picker vervangen door een browser natve `<input type="date">` implementatie. Dit betekent iets minder invloed maar veel betere toegankelijkheid.
