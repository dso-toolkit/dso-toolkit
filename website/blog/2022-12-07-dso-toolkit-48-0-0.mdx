...
## Nieuwe distributie in `@dso-toolkit/core`.

De toolkit maakt gebruik van [Stencil](https://stenciljs.com). Stencil compileert naar verschillende "distributies". Voorheen maakt de toolkit van de `dist` en `dist-custom-elements-bundle` release gebruik. Sinds deze release is de `dist-custom-elements-bundle` distributie vervangen met `dist-custom-elements`.
