...
Daarnaast raden wij aan om ook gebruik te maken van framework bindings als een afnemer Web Componenten gaat gebruiken.
...
Zonder framework bindings moet de afnemer elk Web Component afzonderlijk registreren. Naarmate het aantal afgenomen componenten toeneemt wordt dit een foutgevoelige taak.
...
Bij deze distributie worden alle Web Components geregistreerd (met `customElements.define()`) maar wordt het component pas ingeladen als het wordt gebruikt.
