...
<table>
    <tr>
        <th></th>
        <th>BreedteBreedte</th>
        <th>Aantal kolommen</th>
    </tr>
    <tr>
        <th>xs-min (extra small)</th>
        <td>&gt;= 480px</td>
        <td>2</td>
    </tr>
    <tr>
        <th>xs-max (extra small)</th>
        <td>&lt;= 767px</td>
        <td>2</td>
    </tr>
    <tr>
...
- De gutter breedte is voor elk breakpoint gelijk. 16px aan beide zijdes. 32px in totaal.
