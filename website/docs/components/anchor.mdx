...
<StorybookComponent
  ...
  variant="default&args=label:Externe+website;iconMode:after;modifier:extern"
/>
...
<StorybookComponent
  implementations={["html-css"]}
  variant="default&args=label:Download+document;iconMode:after;modifier:download"
/>
