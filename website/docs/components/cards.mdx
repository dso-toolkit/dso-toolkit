...
<StorybookComponent name="card" implementations={["core", "html-css", "react"]} variant="default" />

### With Button

<StorybookComponent name="card" implementations={["core", "html-css", "react"]} variant="with-button" />

### With Label

<StorybookComponent name="card" implementations={["core", "html-css", "react"]} variant="with-label" />

### With Selectable And Button

<StorybookComponent name="card" implementations={["core", "html-css", "react"]} variant="with-selectable-and-button" />

### With Slide Toggle

<StorybookComponent name="card" implementations={["core", "html-css", "react"]} variant="with-slide-toggle" />

### With Toggletip

<StorybookComponent name="card" implementations={["core", "html-css", "react"]} variant="with-toggletip" />

Een Card mag uitsluitend in een <Link to="./card-container#card-list">Card List</Link> of <Link to="./card-container#card-grid">Card Grid</Link>
worden gebruikt.
