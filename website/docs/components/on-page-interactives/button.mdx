...
<StorybookComponent implementations={["html-css"]} variant="primary" args={{ label: "Anchor", element: "anchor" }} />

#### Small

<StorybookComponent implementations={["html-css"]} variant="primary" args={{ label: "Small", compact: true }} />

✨ Zie voor meer voorbeelden en het gebruik van de primaire button de [button-row](/components/layout/button-row) pagina.
...
✨ Zie voor meer voorbeelden en het gebruik van de secondary button de [button-row](/components/layout/button-row) pagina.
...
✨ Zie voor meer voorbeelden en het gebruik van de tertiare button de [button-row](/components/layout/button-row) pagina.
