...
<StorybookComponent name="form-form-buttons" implementations={["html-css"]} variant="default" />

### Paginering door stappen

<StorybookComponent name="form-form-buttons" implementations={["html-css"]} variant="multi-page" />

### Single page

<StorybookComponent name="form-form-buttons" implementations={["html-css"]} variant="single-page" />
