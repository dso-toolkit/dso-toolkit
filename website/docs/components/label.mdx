...
<StorybookComponent name="label-deprecated" implementations={["html-css"]} variant="default" />
...
<StorybookComponent implementations={["core", "angular", "react"]} variant="truncate" />
...
<StorybookComponent implementations={["core", "angular", "react"]} variant="with-action" />
