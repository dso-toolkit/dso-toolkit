...
<StorybookComponent implementations={["css"]} name="voorbeeldpagina-s-snippets-table-data-table" />
...
<StorybookComponent implementations={["css"]} name="voorbeeldpagina-s-snippets-table-data-grid" />
