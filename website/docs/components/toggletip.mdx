...
Plaats geen cruciale informatie of lange teksten in een toggletip. Overweeg om voor langere inhoud een modal te gebruiken.

En beter nog; als je de ruimte hebt gebruik dan geen toggletips, maar duidelijke labels en vaste content op de pagina.
