...
<StorybookComponent isExamplePage name="voorbeeldpagina-s-snippets-table-data-table" variant="data-table" />
...
<StorybookComponent isExamplePage name="voorbeeldpagina-s-snippets-table-data-grid" variant="data-grid" />
