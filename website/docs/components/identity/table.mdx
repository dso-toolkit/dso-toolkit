...
<StorybookComponent implementations={["core", "react"]} variant="default" />
...
<StorybookComponent isExamplePage={true} name="voorbeeldpagina-s-snippets-table-data-table" variant="data-table" />
...
Zie ook: [Definition List](/components/lists/definition-list).
...
<StorybookComponent isExamplePage={true} name="voorbeeldpagina-s-snippets-table-data-grid" variant="data-grid" />
