...
## Buttons op witte, lichte en donkere achtergrond

<StorybookComponent name="patronen-button-on-color" isExamplePage={true} variant="button-on-color" />

Hierboven staan alle buttons getoond op een witte, licht en donkere achtergrond. De achtergrondkleur van de content bepaalt de achtergrond en tekst kleur de button.
