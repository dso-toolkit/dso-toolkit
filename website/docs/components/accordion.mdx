...
- [Compact](#compact-accordion)
- [Conclusie](#conclusie-accordion)
...
### <a name="compact-accordion"></a>Compact

<StorybookComponent name="accordion--default&args=variant:compact" implementations={["core"]} />

### <a name="conclusie-accordion"></a>Conclusie

<StorybookComponent name="accordion--default&args=variant:conclusion" implementations={["core"]} />
