...
<StorybookComponent variant="success" implementations={["core", "react", "angular"]} />

De HTML/CSS implementatie is **Deprecated**:

<StorybookComponent variant="success" name="alert-deprecated" implementations={["html-css"]} />
